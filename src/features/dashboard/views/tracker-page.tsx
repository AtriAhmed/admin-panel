...
import { trackerColumns, trackerTasks } from "../data/tracker";
...
function TrackerCardContextMenu({
  ...
  const otherColumns = trackerColumns.filter((c) => c !== column);
