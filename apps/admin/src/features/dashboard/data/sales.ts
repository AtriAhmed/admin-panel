...
export const salesChartData: readonly SalesPoint[] = [
  { month: "01", sales: 30 },
  { month: "02", sales: 53 },
  { month: "03", sales: 35 },
  { month: "04", sales: 17 },
...
export const statsCards: readonly StatsCard[] = [
...
export type SalesMiniKpi = {
  currency?: string;
  label: string;
  value: number;
};

export const salesMiniKpis: readonly SalesMiniKpi[] = [
